...
public class ListeTuiles {
    ...
    private ArrayList<ImageContainer> imageInondée =  new ArrayList<>();
    ...
    public ListeTuiles(){
        ...
        this.imageInondée.add(new ImageContainer(s+"LeLagonPerdu_Inonde.png",0,0,0,0));
        
        this.nom.add("Le Marais Brumeux");
        this.image.add(new ImageContainer(s+"LeMaraisBrumeux.png",0,0,0,0));
        this.imageInondée.add(new ImageContainer(s+"LeMaraisBrumeux_Inonde.png",0,0,0,0));
        
        this.nom.add("Observatoire");
        this.image.add(new ImageContainer(s+"Observatoire.png",0,0,0,0));
        this.imageInondée.add(new ImageContainer(s+"Observatoire_Inonde.png",0,0,0,0));
        
        this.nom.add("Le Rocher Fantome");
        this.image.add(new ImageContainer(s+"LeRocherFantome.png",0,0,0,0));
        this.imageInondée.add(new ImageContainer(s+"LeRocherFantome_Inonde.png",0,0,0,0));
     ...
     * @return the image
     */
    public ImageContainer getImagesInondes(int i) {
        return (ImageContainer) this.image.get(i);
    }
